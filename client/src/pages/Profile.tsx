...
import { MicrolearningSettings } from "@/components/MicrolearningSettings";
      ...
      <ContentContainer isSidebarOpen={sidebarOpen}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 bg-white rounded-lg shadow-md overflow-hidden">
            <div className="bg-[#13294B] text-white p-4">
              <h3 className="font-bold text-lg">Application Settings</h3>
              <p className="text-sm text-[#B8C5D9]">Customize your learning experience</p>
            </div>
            
            <div className="p-4">
              <MicrolearningSettings className="mb-4" />
