  ...
  return (
    <div className="flex flex-col h-screen max-h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 flex overflow-hidden">
          {showRationale[currentQuestion.id] ? (
            <>
              ...
              {/* Right panel - Explanation with independent scrolling */}
        ...
        {showRationale[currentQuestion.id] && (
          <div className="md:hidden flex-shrink-0 bg-blue-50 p-2 border-t">
      ...
      <div className="bg-gray-100 border-t border-gray-200 py-2 px-2 sm:py-3 sm:px-4 flex flex-wrap items-center justify-between gap-y-2 flex-shrink-0">
        ...
        <div className="flex items-center space-x-1 sm:space-x-3">
          <button
            ...
            className={`flex items-center py-1 px-2 sm:py-1.5 sm:px-3 text-xs sm:text-sm border rounded ${
          ...
          <span className="hidden sm:inline-block text-xs bg-gray-200 px-2 py-1 rounded-md">
